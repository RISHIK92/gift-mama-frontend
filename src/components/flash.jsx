  ...
  const fetchActiveFlashSales = async () => {
    try {
      ...
      if (response.data.length > 0) {
        await Promise.all(
          response.data.map((sale) => fetchSaleDetails(sale.id))
        );
      }
      setLoading(false);
    } catch (err) {
      ...
      const formattedProducts = response.data.items.map((item) => ({
        ...
        image:
          item.product.images && item.product.images.length > 0
            ? item.product.images[0].displayImage
            : null,
      }));
    ...
    return (
      <div className="bg-gradient-to-b from-red-50 to-white p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          We're preparing some amazing deals for you! Check back soon for
          upcoming flash sales.
        </p>
        <button
          className="bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition-colors font-medium flex items-center justify-center mx-auto"
      ...
      <div className="bg-gradient-to-r from-red-600 to-red-500 text-white px-4 py-10">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-red-100 text-center max-w-2xl mx-auto text-lg mb-6">
            Limited-time offers at unbeatable prices. Grab them before they're
            gone!
          </p>
            ...
            <div className="relative max-w-4xl mx-auto flex justify-center">
              ...
              <div className="relative w-full max-w-2xl">
                <div
                  ...
                  onScroll={(e) =>
                    setTabScrollPosition(e.currentTarget.scrollLeft)
                  }
          ...
          {flashSales[activeTab] &&
            timeLeft[flashSales[activeTab].id] &&
            !timeLeft[flashSales[activeTab].id]?.expired && (
          ...
          >
            ...
            {!saleProducts[sale.id] ? (
              ...
              <div className="text-center py-12 text-gray-600">
                No products available for this sale.
              </div>
            ) : (
                ...
                {saleProducts[sale.id].map((product) => (
                  ...
                  >
                    <div className="relative">
                      ...
                      <div
                        className="h-48 bg-gray-50 flex items-center justify-center p-6 group-hover:bg-gray-100 transition-colors"
                    ...
                    <div className="p-4">
                      <h3
                        className="font-medium text-gray-900 line-clamp-2 h-12 text-lg"
                        onClick={() => navigate(`/product/${product.name}`)}
                      >
                        {product.name}
                      </h3>
                      ...
                      <div className="flex items-center gap-2 mt-4">
                        <button
                          onClick={() =>
                            handleAddToCart(product.id, product.salePrice)
                          }
