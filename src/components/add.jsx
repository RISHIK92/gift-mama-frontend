    ...
    return (
        <div className="h-auto w-96 bg-[#FFD9C4] rounded-3xl p-8 shadow-lg">
            ...
            <div className="flex justify-center mt-6">
                <CustomButton type="CustomButton" className="w-full py-3 rounded-xl bg-custom-orange text-white font-medium transition duration-300 hover:bg-[#ff9a66]"
                    onClick={handleRegister}>Register</CustomButton>
            </div>

            <div className="flex justify-center mt-3">
                <CustomButton className="text-gray-500 text-sm" onClick={onClose}>Cancel</CustomButton>
            </div>
        </div>
    );
}
