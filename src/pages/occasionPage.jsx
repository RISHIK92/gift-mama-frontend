  ...
  return (
    <div className="bg-white">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center">
                      ...
                      <h2 className="text-2xl font-bold text-gray-900">
                        Specially Curated Gifts for {occasionName}
                      </h2>
                    </div>
      ...
      <div className="container mx-auto px-6 lg:px-16 py-12">
        <div
          className="rounded-xl overflow-hidden shadow-lg relative bg-gradient-to-r from-red-500 to-red-500 h-64"
        ...
        >
          <div className="absolute inset-0 flex items-center">
            <div className="p-8 md:p-12 max-w-md">
              ...
              <button
                className="bg-white text-red-600 px-6 py-3 rounded-lg font-bold shadow-lg hover:bg-red-50 transition-all"
                onClick={(e) => {
                  e.stopPropagation();
                  navigate("/all");
                }}
