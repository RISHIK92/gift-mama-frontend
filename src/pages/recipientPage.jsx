...
import { ShoppingBag, Gift, ChevronRight, Tag, ArrowUpDown, Filter, Heart, User } from "lucide-react";
...
export function RecipientPage() {
  ...
  const recipientExists = allRecipients.some(
    recipient => recipient.recipients.toLowerCase() === recipientName?.toLowerCase()
  );
    ...
    <div className="bg-white">
        ...
        <div className="bg-red-600 h-72 flex items-center relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 lg:px-16 z-10 flex flex-col md:flex-row items-center justify-between">
            <div className="text-left max-w-lg mb-8 md:mb-0">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">For {recipientName}</h1>
              <p className="text-white text-opacity-90 text-lg">
                Thoughtfully chosen gifts to delight every {recipientName} in your life
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="p-5 bg-gradient-to-r from-red-500 to-red-400">
            <div className="flex items-center mb-1">
              ...
              <h2 className="text-xl font-bold text-white">Special Gifts for {recipientName}</h2>
            </div>
          </div>
                ...
                <div key={index} className="mb-16">
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center">
                      ...
                      <h2 className="text-2xl font-bold text-gray-900">Specially Curated Gifts for {recipientName}</h2>
                    </div>
                  </div>
          ...
          <div className="container mx-auto px-6 lg:px-16 py-8">
            <div className="mb-16">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                  <div className="w-1 h-8 bg-red-600 mr-4"></div>
                  <h2 className="text-2xl font-serif italic text-gray-900">All {recipientName} Gifts</h2>
                </div>
              </div>
        ...
        <div className="container mx-auto px-6 lg:px-16 py-16 text-center">
          <div className="bg-white rounded-xl shadow-lg p-10">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              We're currently updating our {recipientName} collection. Please check back soon for exciting new products.
            </p>
          </div>
        </div>
      )}
        ...
        <div className="rounded-xl overflow-hidden shadow-lg relative">
          ...
          <div className="absolute z-20 left-0 top-0 w-full h-full flex items-center">
            <div className="p-8 md:p-12 max-w-md">
              ...
              <p className="text-white text-opacity-90 mb-6">Find the perfect gift to celebrate your special {recipientName}.</p>
      ...
      <div className="container mx-auto px-6 lg:px-16 py-12">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 max-w-lg mx-auto">Discover why our {recipientName} gifts are loved by customers across the country</p>
        </div>
          ...
          {[1, 2, 3].map((index) => (
            <div key={index} className="bg-gray-50 p-6 rounded-xl">
              ...
              <p className="text-gray-600">
                "The {recipientName} gift I purchased was perfect. Fast delivery and beautiful packaging. Will definitely shop again!"
              </p>
            </div>
          ))}
        </div>
